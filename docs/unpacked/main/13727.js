...
exports.parsePromoteDemoteResponseSuccessPromote = function (e, t) {
  const n = (0, d.assertTag)(e, "iq");
  if (!n.success) {
    return n;
  }
  const a = (0, d.flattenedChildWithTag)(e, "promote");
  if (!a.success) {
    return a;
  }
  ...
  return (0, o.makeResult)((0, r.default)((0, r.default)({}, l.value), {}, {
    ...
    promoteParticipant: c.value
  }));
};
exports.parsePromoteDemoteResponseSuccessPromotePromoteParticipant = f;
...
function f(e) {
  ...
  const r = (0, d.optional)(d.attrStringEnum, e, "error", l.ENUM_404_419);
  if (!r.success) {
    return r;
  }
