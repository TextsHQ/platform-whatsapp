...
exports.parsePromoteDemoteAdminResponseSuccessMultiAdmin = function (e, t) {
  const n = (0, d.assertTag)(e, "iq");
  if (!n.success) {
    return n;
  }
  const a = (0, d.flattenedChildWithTag)(e, "admin");
  if (!a.success) {
    return a;
  }
  ...
  const c = (0, d.mapChildrenWithTag)(a.value, "participant", 0, 19999, f);
  if (!c.success) {
    return c;
  }
  return (0, o.makeResult)((0, r.default)((0, r.default)({}, l.value), {}, {
    groupAddressingModeMixin: s.success ? s.value : null,
    adminParticipant: c.value
  }));
};
exports.parsePromoteDemoteAdminResponseSuccessMultiAdminAdminParticipant = f;
...
function f(e) {
  ...
  const a = (0, d.optionalLiteral)(d.attrString, e, "type", "admin");
  if (!a.success) {
    return a;
  }
  const r = (0, d.optional)(d.attrStringEnum, e, "error", l.ENUM_403_404_406_419);
  if (!r.success) {
    return r;
  }
  const i = (0, s.parsePhoneNumberMixin)(e);
