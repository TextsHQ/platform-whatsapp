...
exports.requireBundle = exports.SendGroupInviteFlowLoadable = undefined;
...
const d = (0, i.default)((0, r.default)(function* () {
  const e = yield Promise.all([require.e(8295), require.e(1702), require.e(9488), require.e(2790), require.e(275)]).then(require.bind(require, 685066));
...
const f = (0, o.default)({
  ...
  loading: e => c.default.createElement(u.default, {
    title: s.fbt._("Send link to", null, {
      hk: "2Qb3Z6"
    }),
    error: Boolean(e.error)
  })
});
exports.SendGroupInviteFlowLoadable = f;