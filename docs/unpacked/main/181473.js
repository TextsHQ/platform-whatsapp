...
exports.parseGetLinkedAccountsResponseForbidden = function (e, t) {
  ...
  const s = (0, i.parseIQErrorForbiddenMixin)(a.value);
  if (!s.success) {
    return s;
  }
