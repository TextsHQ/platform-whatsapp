...
exports.requireBundle = exports.AttachProductModalLoadable = undefined;
...
const d = (0, i.default)((0, r.default)(function* () {
  const e = yield Promise.all([require.e(8295), require.e(1702), require.e(9488), require.e(2790), require.e(275)]).then(require.bind(require, 761035));
...
const f = (0, o.default)({
  ...
  loading: e => c.default.createElement(u.default, {
    title: s.fbt._("Send products", null, {
      hk: "3C7pQj"
    }),
    error: Boolean(e.error)
  })
});
exports.AttachProductModalLoadable = f;