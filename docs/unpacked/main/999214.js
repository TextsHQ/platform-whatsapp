...
exports.parseAddParticipantsClientErrors = function (e) {
  ...
  const h = (0, d.parseIQErrorRateOverlimitMixin)(e);
  if (h.success) {
    return (0, a.makeResult)({
  ...
  return (0, f.errorMixinDisjunction)(e, ["IQErrorBadRequest", "IQErrorItemNotFound", "IQErrorNotAuthorized", "IQErrorForbidden", "IQErrorRateOverlimit", "IQErrorNotAllowed", "IQErrorLocked", "IQErrorFallbackClient"], [t, n, p, m, h, g, E, v]);
};
