...
exports.destroyStorage = function () {
  if (u == null) {
    return Promise.reject((0, o.default)("[offd-storage] Storage should be created first before being destroyed"));
  }
  return u.purge().then(() => {
    u = null;
  }).catch(e => {
...
exports.getStorage = function () {
  (0, s.default)(u != null, "[offd-storage] Storage should be created first before being accessed");
  return u;
};
