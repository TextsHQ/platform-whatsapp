...
exports.parseUnmuteResponseSuccess = function (e, t) {
  const n = (0, c.assertTag)(e, "iq");
  if (!n.success) {
    return n;
  }
  const r = (0, c.flattenedChildWithTag)(e, "unmute");
  if (!r.success) {
    return r;
  }
  ...
  return (0, a.makeResult)((0, i.default)((0, i.default)({}, s.value), {}, {
    unmuteNewsletter: l.value
  }));
};
exports.parseUnmuteResponseSuccessUnmuteNewsletter = d;
