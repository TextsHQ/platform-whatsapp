...
exports.parseGetAccessTokenAndSessionCookiesResponseTooManyAttempts = function (e, t) {
  ...
  const l = (0, s.literal)(s.attrString, r.value, "code", "431");
  if (!l.success) {
    return l;
  }
  const u = (0, s.literal)(s.attrString, r.value, "text", "TOO_MANY_ATTEMPTS");
  if (!u.success) {
    return u;
  }
