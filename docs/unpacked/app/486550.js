...
exports.parseGetGroupInfoResponseClientError = function (e, t) {
  ...
  const c = (0, o.parseGetGroupInfoClientErrors)(r.value);
  if (!c.success) {
    return c;
  }
  return (0, a.makeResult)((0, i.default)((0, i.default)({}, u.value), {}, {
    errorGetGroupInfoClientErrors: c.value
  }));
};
var i = r(require("../vendor/73982.js"));
var a = require("./135781.js");
var o = require("./764920.js");
