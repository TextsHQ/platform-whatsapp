...
exports.destroyStorage = function () {
  if (u == null) {
    return Promise.reject((0, o.default)("[signal-storage] Storage should be created first before being destroyed"));
  }
  return u.purge().then(() => {
    u = null;
  }).catch(e => {
...
exports.getStorage = function () {
  (0, s.default)(u != null, "[signal-storage] Storage should be created first before being accessed");
  return u;
};
