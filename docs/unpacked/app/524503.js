...
exports.addProductMD = function () {
  return f.apply(this, arguments);
};
exports.addProductResponse = undefined;
...
const p = new s.WapParser("addProductResponse", e => {
  e.assertTag("iq");
  e.assertFromServer();
  const t = e.child("product_catalog_add").child("product");
...
function f() {
  return (f = (0, i.default)(function* (e, t, n) {
    ...
    throw i.customError != null ? new l.CatalogEditServerError(i.errorCode, i.customError) : new l.ServerStatusCodeError(i.errorCode);
  })).apply(this, arguments);
}
exports.addProductResponse = p;