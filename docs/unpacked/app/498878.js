...
exports.parseSetResponseError = function (e, t) {
  ...
  const c = (0, s.parseUsernameSetErrorResponses)(r.value);
  if (!c.success) {
    return c;
  }
  return (0, a.makeResult)((0, i.default)((0, i.default)({}, u.value), {}, {
    errorUsernameSetErrorResponses: c.value
  }));
};
var i = r(require("../vendor/73982.js"));
var a = require("./135781.js");
var o = require("./309491.js");
var s = require("./743148.js");
